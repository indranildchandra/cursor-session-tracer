...
This directory holds the **plan** half of the two-artefact model:
...
| Artefact | Produced by | Lives in | Answers |
|---|---|---|---|
...
reviewer that reads both artefacts and flags **LLD drift**: files the trace
